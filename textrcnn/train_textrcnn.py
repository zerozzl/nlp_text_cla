...
from textrcnn.model import TextRCNN
...
def main(args):
    ...
    if args.pretrained_model_path is not None:
        ...
        model = TextRCNN(len(tag_to_id), len(token_to_id), args.embed_size, args.hidden_size,
